...
**Core Analysis Task**
Carefully examine the company's official website: {input_data.company_url}
- Extract and summarize from the site: official company name, core business description (2-3 sentences), main product/service names, target customer segments, and key value propositions.

**Web-Enabled Search & Expansion**
Using web search capabilities, supplement the official website information by researching the following:
- **Market & Competition**: Search for "{input_data.company_name} competitors", "top companies or similar terms to identify 3-5 main competitors.
- **Customer Sentiment**: Search for "{input_data.company_name} reviews", "{input_data.company_name} customer feedback", or "{input_data.company_name} user experience" to understand public perception and key points of praise or criticism.
- **Latest Developments**: Search for recent (past 1-2 years) news or industry reports about "{input_data.company_name}" to identify major updates, partnerships, or challenges.

Synthesize all gathered information and Extract SPECIFIC information:
